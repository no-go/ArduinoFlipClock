...
void Adafruit_SSD1306::display(void) {
  ...
  ssd1306_command(95); // Column end address (127 = reset)
...
void Adafruit_SSD1306::setPageAddress(uint8_t add) {
  add=0xb0|add;
  ssd1306_command(add);
  return;
}

void Adafruit_SSD1306::setColumnAddress(uint8_t add) {
  ssd1306_command((0x10|(add>>4))+0x02);
  ssd1306_command((0x0f&add));
  return;
}
